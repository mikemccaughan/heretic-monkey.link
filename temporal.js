...
var INTRINSICS = {
  ...
  '%ArrayBufferPrototype%':
    typeof ArrayBuffer === 'undefined' ? undefined$1 : ArrayBuffer.prototype,
  ...
  '%DataViewPrototype%':
    typeof DataView === 'undefined' ? undefined$1 : DataView.prototype,
  '%Date%': Date,
  ...
  '%Float32ArrayPrototype%':
    typeof Float32Array === 'undefined' ? undefined$1 : Float32Array.prototype,
  '%Float64Array%':
    typeof Float64Array === 'undefined' ? undefined$1 : Float64Array,
  '%Float64ArrayPrototype%':
    typeof Float64Array === 'undefined' ? undefined$1 : Float64Array.prototype,
  '%Function%': Function,
  ...
  '%Int8ArrayPrototype%':
    typeof Int8Array === 'undefined' ? undefined$1 : Int8Array.prototype,
  '%Int16Array%': typeof Int16Array === 'undefined' ? undefined$1 : Int16Array,
  '%Int16ArrayPrototype%':
    typeof Int16Array === 'undefined' ? undefined$1 : Int8Array.prototype,
  '%Int32Array%': typeof Int32Array === 'undefined' ? undefined$1 : Int32Array,
  '%Int32ArrayPrototype%':
    typeof Int32Array === 'undefined' ? undefined$1 : Int32Array.prototype,
  '%isFinite%': isFinite,
  '%isNaN%': isNaN,
  ...
  '%PromisePrototype%':
    typeof Promise === 'undefined' ? undefined$1 : Promise.prototype,
  '%PromiseProto_then%':
    typeof Promise === 'undefined' ? undefined$1 : Promise.prototype.then,
  '%Promise_all%': typeof Promise === 'undefined' ? undefined$1 : Promise.all,
  '%Promise_reject%':
    typeof Promise === 'undefined' ? undefined$1 : Promise.reject,
  '%Promise_resolve%':
    typeof Promise === 'undefined' ? undefined$1 : Promise.resolve,
  ...
  '%Uint8ArrayPrototype%':
    typeof Uint8Array === 'undefined' ? undefined$1 : Uint8Array.prototype,
  '%Uint8ClampedArray%':
  ...
  '%Uint16ArrayPrototype%':
    typeof Uint16Array === 'undefined' ? undefined$1 : Uint16Array.prototype,
  '%Uint32Array%':
    typeof Uint32Array === 'undefined' ? undefined$1 : Uint32Array,
  '%Uint32ArrayPrototype%':
    typeof Uint32Array === 'undefined' ? undefined$1 : Uint32Array.prototype,
  '%URIError%': URIError,
  '%URIErrorPrototype%': URIError.prototype,
  '%WeakMap%': typeof WeakMap === 'undefined' ? undefined$1 : WeakMap,
  '%WeakMapPrototype%':
    typeof WeakMap === 'undefined' ? undefined$1 : WeakMap.prototype,
  '%WeakSet%': typeof WeakSet === 'undefined' ? undefined$1 : WeakSet,
  '%WeakSetPrototype%':
    typeof WeakSet === 'undefined' ? undefined$1 : WeakSet.prototype
};
...
var isDateObject = function isDateObject(value) {
  ...
  return hasToStringTag$1
    ? tryDateObject(value)
    : toStr$2.call(value) === dateClass;
};
...
var AbstractRelationalComparison = function AbstractRelationalComparison(
  x,
  y,
  LeftFirst
) {
...
var inspectSymbol =
  inspectCustom && isSymbol$1(inspectCustom) ? inspectCustom : null;
...
var Get = function Get(O, P) {
  ...
  if (!IsPropertyKey(P)) {
    throw new $TypeError$4(
      'Assertion failed: IsPropertyKey(P) is not true, got ' + objectInspect(P)
    );
  }
  // 7.3.1.3
  return O[P];
...
var AddEntriesFromIterable = function AddEntriesFromIterable(
  target,
  iterable,
  adder
) {
  ...
  while (true) {
    ...
    if (Type$1(nextItem) !== 'Object') {
      var error = new $TypeError$f(
        'iterator next must return an Object, got ' + objectInspect(nextItem)
      );
...
var propIsEnumerable = functionBind.call(
  Function.call,
...
var implementation$2 = function assign(target, source1) {
  ...
  for (s = 1; s < arguments.length; ++s) {
    ...
    var getSymbols =
      hasSymbols$5 && (Object.getOwnPropertySymbols || originalGetSymbols);
    if (getSymbols) {
...
var assertRecord = function assertRecord(
  Type,
  recordType,
  argumentName,
  value
...
var ToPropertyDescriptor = function ToPropertyDescriptor(Obj) {
  ...
  if (
    (src(desc, '[[Get]]') || src(desc, '[[Set]]')) &&
    (src(desc, '[[Value]]') || src(desc, '[[Writable]]'))
  ) {
...
var DefineOwnProperty = function DefineOwnProperty(
  IsDataDescriptor,
  SameValue,
...
var ValidateAndApplyPropertyDescriptor = function ValidateAndApplyPropertyDescriptor(
  O,
  P,
  extensible,
  Desc,
...
var CanonicalNumericIndexString = function CanonicalNumericIndexString(
  argument
) {
...
var CopyDataProperties = function CopyDataProperties(
  target,
  source,
  excludedItems
) {
  ...
  forEach(sourceKeys, function(nextKey) {
    ...
    var enumerable =
      $isEnumerable$2(fromObj, nextKey) ||
...
var GetPrototypeFromConstructor = function GetPrototypeFromConstructor(
  constructor,
...
var isStringOrHole = function(capture, index, arr) {
  return (
    Type$1(capture) === 'String' ||
    (canDistinguishSparseFromUndefined
      ? !(index in arr)
      : Type$1(capture) === 'Undefined')
  );
};
...
var GetSubstitution = function GetSubstitution(
  matched,
  str,
  position,
  captures,
    ...
    if (current === '$' && !isLast) {
      ...
      if (next === '$') {
        ...
        if (
          ...
          // if (n > m, impl-defined)
          result +=
            n <= m && Type$1(captures[n - 1]) === 'Undefined'
              ? ''
              : captures[n - 1];
          i += 1;
          ...
          result +=
            nn <= m && Type$1(captures[nnI]) === 'Undefined'
              ? ''
              : captures[nnI];
          i += 2;
        } else if (next === '<') {
...
function MakeIntrinsicClass(Class, name) {
  ...
  try {
    for (
      var _iterator = Object.getOwnPropertyNames(Class)[Symbol.iterator](),
        _step;
  ...
  try {
    for (
      var _iterator2 = Object.getOwnPropertyNames(Class.prototype)[
          Symbol.iterator
        ](),
        _step2;
    ...
    [
      {
        ...
        value: function _with(dateTimeLike, options) {
          ...
          var props = ES.ValidPropertyBag(dateTimeLike, [
            'year',
            'month',
            'day',
            'hour',
          ...
          var _props$year = props.year,
            ...
            month =
              _props$month === void 0 ? GetSlot(this, MONTH) : _props$month,
            ...
            minute =
              _props$minute === void 0 ? GetSlot(this, MINUTE) : _props$minute,
            _props$second = props.second,
            second =
              _props$second === void 0 ? GetSlot(this, SECOND) : _props$second,
            _props$millisecond = props.millisecond,
            millisecond =
              _props$millisecond === void 0
                ? GetSlot(this, MILLISECOND)
                : _props$millisecond,
            _props$microsecond = props.microsecond,
            microsecond =
              _props$microsecond === void 0
                ? GetSlot(this, MICROSECOND)
                : _props$microsecond,
            _props$nanosecond = props.nanosecond,
            nanosecond =
              _props$nanosecond === void 0
                ? GetSlot(this, NANOSECOND)
                : _props$nanosecond;

          var _ES$RegulateDateTime = ES.RegulateDateTime(
            year,
            month,
            day,
            hour,
      ...
      },
      {
        ...
        value: function plus(durationLike, options) {
          ...
          var _ES$RegulateDateTime2 = ES.RegulateDateTime(
            year,
            month,
            day,
            hour,
      ...
      },
      {
        ...
        value: function minus(durationLike, options) {
          ...
          var _ES$SubtractTime = ES.SubtractTime(
            hour,
            minute,
            second,
            millisecond,
          ...
          var _ES$SubtractDate = ES.SubtractDate(
            year,
            month,
            day,
            years,
          ...
          var _ES$RegulateDateTime3 = ES.RegulateDateTime(
            year,
            month,
            day,
            hour,
      ...
      },
      {
        ...
        value: function difference(other, options) {
          ...
          var _ES$DifferenceDate = ES.DifferenceDate(
              smaller,
              {
                year: year,
                month: month,
          ...
          var _ES$BalanceDuration = ES.BalanceDuration(
            days,
            hours,
            minutes,
            seconds,
      ...
      },
      {
        ...
        value: function toString() {
          ...
          var second = ES.ISOSecondsString(
            GetSlot(this, SECOND),
            GetSlot(this, MILLISECOND),
            GetSlot(this, MICROSECOND),
            GetSlot(this, NANOSECOND)
    ...
    [
      ...
      },
      {
        ...
        value: function compare(one, two) {
          if (!ES.IsDateTime(one) || !ES.IsDateTime(two))
            throw new TypeError('invalid DateTime object');
          if (one.year !== two.year)
            return ES.ComparisonResult(one.year - two.year);
          if (one.month !== two.month)
            return ES.ComparisonResult(one.month - two.month);
          if (one.day !== two.day)
            return ES.ComparisonResult(one.day - two.day);
          if (one.hour !== two.hour)
            return ES.ComparisonResult(one.hour - two.hour);
          if (one.minute !== two.minute)
            return ES.ComparisonResult(one.minute - two.minute);
          if (one.second !== two.second)
            return ES.ComparisonResult(one.second - two.second);
          if (one.millisecond !== two.millisecond)
            return ES.ComparisonResult(one.millisecond - two.millisecond);
          if (one.microsecond !== two.microsecond)
            return ES.ComparisonResult(one.microsecond - two.microsecond);
          if (one.nanosecond !== two.nanosecond)
            return ES.ComparisonResult(one.nanosecond - two.nanosecond);
  ...
  _createClass(
    ...
    [
      {
        ...
        value: function _with() {
          ...
          var _ES$RegulateDate = ES.RegulateDate(
            year,
            month,
            day,
            disambiguation
      ...
      },
      {
        ...
        value: function plus() {
          ...
          var _ES$RegulateDate2 = ES.RegulateDate(
            year,
            month,
            day,
            disambiguation
      ...
      },
      {
        ...
        value: function minus() {
          ...
          var _ES$RegulateDate3 = ES.RegulateDate(
            year,
            month,
            day,
            disambiguation
    ...
    [
      ...
      },
      {
        key: 'compare',
        value: function compare(one, two) {
          if (!ES.IsDate(one) || !ES.IsDate(two))
    ...
    [
      {
        ...
        value: function _with() {
          ...
          return Construct === YearMonth
            ? result
            : new Construct(GetSlot(result, YEAR), GetSlot(result, MONTH));
        }
      },
      {
        key: 'plus',
      ...
      },
      {
        ...
        value: function difference(other, options) {
          if (!ES.IsYearMonth(this)) throw new TypeError('invalid receiver');
          if (!ES.IsYearMonth(other))
            throw new TypeError('invalid YearMonth object');
          var largestUnit = ES.ToLargestTemporalUnit(options, 'years', [
            'days',
            'hours',
            'minutes',
            'seconds'
    ...
    [
      {
        ...
        value: function from(arg) {
          ...
          return this === YearMonth
            ? result
            : new this(GetSlot(result, YEAR), GetSlot(result, MONTH));
        }
      },
      {
        key: 'compare',
        value: function compare(one, two) {
          if (!ES.IsYearMonth(one) || !ES.IsYearMonth(two))
            throw new TypeError('invalid YearMonth object');
          if (one.year !== two.year)
            return ES.ComparisonResult(one.year - two.year);
          if (one.month !== two.month)
    ...
    [
      {
        ...
        value: function _with(dateLike, options) {
          ...
          return this === MonthDay
            ? result
            : new Construct(GetSlot(result, MONTH), GetSlot(result, DAY));
        }
      },
      {
        key: 'toString',
    ...
    [
      {
        ...
        value: function from(arg) {
          ...
          return this === MonthDay
            ? result
            : new this(GetSlot(result, MONTH), GetSlot(result, DAY));
        }
      },
      {
        key: 'compare',
        value: function compare(one, two) {
          if (!ES.IsMonthDay(one) || !ES.IsMonthDay(two))
            throw new TypeError('invalid MonthDay object');
          if (one.month !== two.month)
            return ES.ComparisonResult(one.month - two.month);
          if (one.day !== two.day)
            return ES.ComparisonResult(one.day - two.day);
  ...
  _createClass(
    ...
    [
      {
        ...
        value: function _with() {
          ...
          var disambiguation = ES.ToDisambiguation(options);
          var props = ES.ValidPropertyBag(timeLike, [
            'hour',
            'minute',
            'second',
            'millisecond',
      ...
      },
      {
        ...
        value: function toString() {
          ...
          var hour = ES.ISODateTimePartString(GetSlot(this, HOUR));
          var minute = ES.ISODateTimePartString(GetSlot(this, MINUTE));
          var seconds = ES.ISOSecondsString(
            GetSlot(this, SECOND),
            GetSlot(this, MILLISECOND),
            GetSlot(this, MICROSECOND),
            GetSlot(this, NANOSECOND)
    ...
    [
      ...
      },
      {
        key: 'compare',
        value: function compare(one, two) {
          if (!ES.IsTime(one) || !ES.IsTime(two))
            throw new TypeError('invalid Time object');
          if (one.hour !== two.hour)
            return ES.ComparisonResult(one.hour - two.hour);
          if (one.minute !== two.minute)
            return ES.ComparisonResult(one.minute - two.minute);
...
var Absolute = /*#__PURE__*/ (function() {
  function Absolute(epochNanoseconds) {
    ...
    if (
      'bigint' !== typeof epochNanoseconds &&
      !BigInteger.isInstance(epochNanoseconds)
    )
    ...
    [
      ...
      },
      {
        ...
        value: function plus(durationLike) {
          ...
          var _ES$ToLimitedDuration = ES.ToLimitedDuration(durationLike, [
              YEARS,
              MONTHS
            ]),
      ...
      },
      {
        ...
        value: function minus(durationLike) {
          ...
          var _ES$ToLimitedDuration2 = ES.ToLimitedDuration(durationLike, [
              YEARS,
              MONTHS
            ]),
      ...
      },
      {
        ...
        value: function difference(other, options) {
          if (!ES.IsAbsolute(this)) throw new TypeError('invalid receiver');
          if (!ES.IsAbsolute(other))
            throw new TypeError('invalid Absolute object');
          var largestUnit = ES.ToLargestTemporalUnit(options, 'seconds', [
            'years',
            'months'
          ]);
    ...
    [
      ...
      },
      {
        ...
        value: function fromEpochMilliseconds(epochMillisecondsParam) {
          var epochNanoseconds = BigInteger(epochMillisecondsParam).multiply(
            1e6
          );
          ES.RejectAbsolute(epochNanoseconds);
          var result = new this(epochNanoseconds.value);
      ...
      },
      {
        key: 'compare',
        value: function compare(one, two) {
          if (!ES.IsAbsolute(one) || !ES.IsAbsolute(two))
            throw new TypeError('invalid Absolute object');
...
var TimeZone = /*#__PURE__*/ (function() {
  function TimeZone(timeZoneIdentifier) {
    ...
    SetSlot(
      this,
      IDENTIFIER,
      ES.GetCanonicalTimeZoneIdentifier(timeZoneIdentifier)
    );
  }
    ...
    [
      {
        ...
        value: function getOffsetFor(absolute) {
          ...
          if (!ES.IsAbsolute(absolute))
            throw new TypeError('invalid Absolute object');
          return ES.GetTimeZoneOffsetString(
            GetSlot(absolute, EPOCHNANOSECONDS),
      ...
      },
      {
        ...
        value: function getDateTimeFor(absolute) {
          ...
          var _ES$GetTimeZoneDateTi = ES.GetTimeZoneDateTimeParts(
              ns,
              GetSlot(this, IDENTIFIER)
            ),
      ...
      },
      {
        ...
        value: function getAbsoluteFor(dateTime, options) {
          ...
          var possibleEpochNs = ES.GetTimeZoneEpochValue(
            GetSlot(this, IDENTIFIER),
            year,
            month,
            day,
          ...
          var utcns = ES.GetEpochFromParts(
            year,
            month,
            day,
            hour,
          ...
          var before = ES.GetTimeZoneOffsetNanoseconds(
            utcns.minus(BigInteger(86400 * 1e9)),
            GetSlot(this, IDENTIFIER)
          );
          var after = ES.GetTimeZoneOffsetNanoseconds(
            utcns.plus(BigInteger(86400 * 1e9)),
            GetSlot(this, IDENTIFIER)
          );
    ...
    [
      {
        ...
        value: function from(arg) {
          ...
          return this === TimeZone
            ? result
            : new this(GetSlot(result, IDENTIFIER));
        }
      }
    ]
  );
...
var Duration = /*#__PURE__*/ (function() {
  function Duration() {
    ...
    for (
      ...
      var prop = _arr[_i];
      if (prop < 0)
        throw new RangeError('negative values not allowed as duration fields');
    ...
    [
      {
        ...
        value: function toString() {
          ...
          var dateParts = [];
          if (GetSlot(this, YEARS))
            dateParts.push(''.concat(formatNumber(GetSlot(this, YEARS)), 'Y'));
          if (GetSlot(this, MONTHS))
            dateParts.push(''.concat(formatNumber(GetSlot(this, MONTHS)), 'M'));
          if (GetSlot(this, DAYS))
            dateParts.push(''.concat(formatNumber(GetSlot(this, DAYS)), 'D'));
          var timeParts = [];
          if (GetSlot(this, HOURS))
            timeParts.push(''.concat(formatNumber(GetSlot(this, HOURS)), 'H'));
          if (GetSlot(this, MINUTES))
            timeParts.push(
              ''.concat(formatNumber(GetSlot(this, MINUTES)), 'M')
            );
          var secondParts = [];
          ...
          if (µs || secondParts.length)
            secondParts.unshift(''.concat(µs).padStart(3, '0'));
          if (ms || secondParts.length)
            secondParts.unshift(''.concat(ms).padStart(3, '0'));
...
var absolute = new RegExp(
  '^'
    .concat(datesplit.source, '(?:T|\\s+)')
    .concat(timesplit.source)
    .concat(zonesplit.source, '$')
);
...
var time = new RegExp(
  '^'.concat(timesplit.source, '(?:').concat(zonesplit.source, ')?$')
);
...
var ES = assign(assign({}, es2019), {
    ...
    if (offset && ianaName) {
      ...
      if (result.getOffsetFor(absolute) !== offset) {
        throw new RangeError(
          'invalid offset '.concat(offset, '[').concat(ianaName, ']')
        );
      }
    }
  ...
  ToDateTime: function ToDateTime(item, disambiguation) {
    ...
    var props = ES.ValidDateTimeFrom(
      item,
      ['year', 'month', 'day'],
  ...
  RegulateDateTime: function RegulateDateTime(
    year,
    month,
    day,
    hour,
    ...
    switch (disambiguation) {
      ...
      case 'constrain':
        var _ES$ConstrainDateTime = ES.ConstrainDateTime(
          year,
          month,
          day,
          hour,
      ...
      case 'balance': {
        ...
        var _ES$BalanceTime = ES.BalanceTime(
          hour,
          minute,
          second,
          millisecond,
  ...
  ToTime: function ToTime(item, disambiguation) {
    ...
    switch (disambiguation) {
      ...
      case 'constrain':
        var _ES$ConstrainTime = ES.ConstrainTime(
          hour,
          minute,
          second,
          millisecond,
      ...
      case 'balance':
        var _ES$BalanceTime2 = ES.BalanceTime(
          hour,
          minute,
          second,
          millisecond,
  ...
  ToDuration: function ToDuration(item, disambiguation) {
    ...
    var props = ES.ValidPropertyBag(item, [
      'years',
      'months',
      'days',
      'hours',
    ...
    switch (disambiguation) {
      case 'reject':
        for (
          ...
          if (prop < 0)
            throw new RangeError(
              'negative values not allowed as duration fields'
            );
          if (!Number.isFinite(prop))
            throw new RangeError(
              'infinite values not allowed as duration fields'
            );
        }
  ...
  ToLimitedDuration: function ToLimitedDuration(item) {
    ...
    try {
      for (
        var _iterator = disallowedSlots[Symbol.iterator](), _step;
        !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
        _iteratorNormalCompletion = true
      ) {
  ...
  ToLargestTemporalUnit: function ToLargestTemporalUnit(options, fallback) {
    var disallowedStrings =
      arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
    var largestUnit = ES.GetOption(
      options,
      'largestUnit',
    ...
    if (disallowedStrings.includes(largestUnit)) {
      throw new RangeError(
        ''.concat(largestUnit, ' not allowed as the largest unit here')
      );
    }
  ...
  ValidPropertyBag: function ValidPropertyBag(bag) {
    ...
    try {
      for (
        var _iterator2 = anyof[Symbol.iterator](), _step2;
        !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done);
        _iteratorNormalCompletion2 = true
      ) {
  ...
  ValidDateTimeFrom: function ValidDateTimeFrom(bag, required) {
    ...
    try {
      for (
        var _iterator3 = required[Symbol.iterator](), _step3;
        ...
        if (!(prop in bag) || typeof bag[prop] === 'undefined') {
          throw new TypeError(
            "required property '".concat(prop, "' missing or undefined")
          );
        }
    ...
    try {
      for (
        var _iterator4 = optional[Symbol.iterator](), _step4;
  ...
  ISOSecondsString: function ISOSecondsString(seconds, millis, micros, nanos) {
    ...
    if (micros || parts.length)
      parts.unshift('000'.concat(micros || 0).slice(-3));
    if (millis || parts.length)
      parts.unshift('000'.concat(millis || 0).slice(-3));
    var secs = '00'.concat(seconds).slice(-2);
    var post = parts.length ? '.'.concat(parts.join('')) : '';
    return ''.concat(secs).concat(post);
  },
  GetCanonicalTimeZoneIdentifier: function GetCanonicalTimeZoneIdentifier(
    timeZoneIdentifier
  ) {
  ...
  GetTimeZoneOffsetNanoseconds: function GetTimeZoneOffsetNanoseconds(
    epochNanoseconds,
    timeZone
  ) {
  ...
  GetTimeZoneOffsetString: function GetTimeZoneOffsetString(
    epochNanoseconds,
    timeZone
  ) {
    var offsetNanos = BigInteger(
      ES.GetTimeZoneOffsetNanoseconds(epochNanoseconds, timeZone)
    );
    var offsetString = makeOffsetString(offsetNanos.divide(1e6));
    return offsetString;
  },
  GetEpochFromParts: function GetEpochFromParts(
    year,
    month,
    day,
    hour,
  ...
  GetTimeZoneDateTimeParts: function GetTimeZoneDateTimeParts(
    epochNanoseconds,
    timeZone
  ) {
    var offset = parseOffsetString(timeZone);
    var nanos = BigInteger(epochNanoseconds).mod(1e9);
    var epochMilliseconds = BigInteger(epochNanoseconds)
      .divide(1e9)
      .multiply(1e3)
    ...
    if (offset !== null) {
      ...
      var _ES$BalanceTime3 = ES.BalanceTime(
        _hour,
        _minute,
        _second,
        millisecond,
    ...
    var _ES$GetFormatterParts = ES.GetFormatterParts(
      timeZone,
      epochMilliseconds
    ).reduce(reduceParts, {});
    ...
    var _ES$BalanceTime4 = ES.BalanceTime(
      hour,
      minute,
      second,
      millisecond,
  ...
  GetTimeZoneNextTransition: function GetTimeZoneNextTransition(
    epochNanoseconds,
    timeZone
  ) {
    var offset = parseOffsetString(timeZone);
  ...
  GetTimeZoneEpochValue: function GetTimeZoneEpochValue(
    timeZone,
    year,
    month,
    day,
    ...
    var found = unique([earliest, latest])
      .map(function(offsetNanoseconds) {
  ...
  BalanceDate: function BalanceDate(year, month, day) {
    ...
    while (
      ((daysInYear = ES.LeapYear(testYear) ? 366 : 365), day < -daysInYear)
    ) {
      year -= 1;
      testYear -= 1;
      day += daysInYear;
  ...
  BalanceSubSecond: function BalanceSubSecond(
    millisecond,
    microsecond,
    nanosecond
  ) {
  ...
  BalanceTime: function BalanceTime(
    hour,
    minute,
    second,
    millisecond,
    ...
    var _ES$BalanceSubSecond = ES.BalanceSubSecond(
      millisecond,
      microsecond,
      nanosecond
    );
  ...
  BalanceDurationDate: function BalanceDurationDate(
    years,
    months,
    startYear,
    startMonth,
    ...
    var _ES$BalanceYearMonth5 = ES.BalanceYearMonth(
        startYear + years,
        startMonth + months
      ),
    ...
    while (startDay > ES.DaysInMonth(year, month)) {
      ...
      var _ES$BalanceYearMonth6 = ES.BalanceYearMonth(
        startYear + years,
        startMonth + months
      );
  ...
  BalanceDuration: function BalanceDuration(
    days,
    hours,
    minutes,
    seconds,
    ...
    var _ES$BalanceTime5 = ES.BalanceTime(
      hours,
      minutes,
      seconds,
      milliseconds,
  ...
  ConstrainDate: function ConstrainDate(year, month, day) {
    ...
    var _ES$ConstrainDateTime2 = ES.ConstrainDateTime(
      year,
      month,
      day,
      12,
  ...
  ConstrainTime: function ConstrainTime(
    hour,
    minute,
    second,
    millisecond,
  ...
  ConstrainDateTime: function ConstrainDateTime(
    year,
    month,
    day,
    hour,
    ...
    var _ES$ConstrainTime2 = ES.ConstrainTime(
      hour,
      minute,
      second,
      millisecond,
  ...
  RejectTime: function RejectTime(
    hour,
    minute,
    second,
    millisecond,
  ...
  RejectDateTime: function RejectDateTime(
    year,
    month,
    day,
    hour,
  ...
  DifferenceDate: function DifferenceDate(smaller, larger) {
    ...
    switch (largestUnit) {
      ...
      case 'months': {
        ...
        var _ES$BalanceDurationDa = ES.BalanceDurationDate(
          years,
          months,
          smaller.year,
          smaller.month,
        ...
        days =
          ES.DayOfYear(larger.year, larger.month, larger.day) -
          ES.DayOfYear(year, month, smaller.day);

        if (days < 0) {
          months -= 1;

          var _ES$BalanceDurationDa2 = ES.BalanceDurationDate(
            years,
            months,
            smaller.year,
            smaller.month,
      ...
      case 'days':
        ...
        days =
          ES.DayOfYear(larger.year, larger.month, larger.day) -
          ES.DayOfYear(smaller.year, smaller.month, smaller.day);
  ...
  DifferenceTime: function DifferenceTime(earlier, later) {
    ...
    var _ES$BalanceTime6 = ES.BalanceTime(
      hours,
      minutes,
      seconds,
      milliseconds,
  ...
  AddTime: function AddTime(
    ...
    var _ES$BalanceTime7 = ES.BalanceTime(
      hour,
      minute,
      second,
      millisecond,
  ...
  SubtractDate: function SubtractDate(
    year,
    month,
    day,
    years,
  ...
  SubtractTime: function SubtractTime(
    hour,
    minute,
    second,
    millisecond,
    ...
    var _ES$BalanceTime8 = ES.BalanceTime(
      hour,
      minute,
      second,
      millisecond,
  ...
  AssertPositiveInteger: function AssertPositiveInteger(num) {
    if (!Number.isFinite(num) || Math.abs(num) !== num)
  ...
  GetOption: function GetOption(options, property, allowedValues, fallback) {
    ...
    if (value !== undefined) {
      ...
      if (!allowedValues.includes(value)) {
        throw new RangeError(
          ''
            .concat(property, ' must be one of ')
            .concat(allowedValues.join(', '), ', not ')
            .concat(value)
        );
      }
...
function makeOffsetString(offsetMilliSeconds) {
  ...
  return ''
    .concat(sign)
    .concat(offsetHourString, ':')
    .concat(offsetMinuteString);
}
    ...
    [
      {
        ...
        value: function format(duration) {
          console.error(
            'Intl.DateTimeFormat.format with a Duration is not fully polyfilled!'
          );
      ...
      },
      {
        ...
        value: function formatToParts(duration) {
          console.error(
            'Intl.DateTimeFormat.formatToParts with a Duration is not fully polyfilled!'
          );
...
function DateTimeFormat() {
  var locale =
    arguments.length > 0 && arguments[0] !== undefined
      ? arguments[0]
      : IntlDateTimeFormat$1().resolvedOptions().locale;
  var options =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
...
DateTimeFormat.supportedLocalesOf = function() {
  return IntlDateTimeFormat$1.supportedLocalesOf.apply(
    IntlDateTimeFormat$1,
    arguments
  );
};
...
DateTimeFormat.prototype = Object.create(
  IntlDateTimeFormat$1.prototype,
  properties
);
...
function format(datetime) {
  ...
  if (datetime instanceof Duration$2) {
    ...
    return (_this$DURATION = this[DURATION]).format.apply(
      _this$DURATION,
      [datetime].concat(rest)
    );
  }

  return (_this$ORIGINAL = this[ORIGINAL]).format.apply(
    _this$ORIGINAL,
    [datetime].concat(rest)
  );
}
...
function formatToParts(datetime) {
  ...
  if (datetime instanceof Duration$2) {
    ...
    return (_this$DURATION2 = this[DURATION]).formatToParts.apply(
      _this$DURATION2,
      [datetime].concat(rest)
    );
  }

  return (_this$ORIGINAL2 = this[ORIGINAL]).formatToParts.apply(
    _this$ORIGINAL2,
    [datetime].concat(rest)
  );
}
...
function formatRange(a, b) {
  if (
    ...
    if (aa && bb && aformatter && bformatter && aformatter === bformatter) {
      return aformatter.formatRange(
        aa.getEpochMilliseconds(),
        bb.getEpochMilliseconds()
      );
    }
  }
...
function formatRangeToParts(a, b) {
  if (
    ...
    if (aa && bb && aformatter && bformatter && aformatter === bformatter) {
      return aformatter.formatRangeToParts(
        aa.getEpochMilliseconds(),
        bb.getEpochMilliseconds()
      );
    }
...
function amend() {
  ...
  for (
    var _i = 0, _arr = ['year', 'month', 'day', 'hour', 'minute', 'second'];
    _i < _arr.length;
    _i++
  ) {
    var opt = _arr[_i];
...
function copy(target, source) {
  ...
  try {
    for (
      var _iterator = Object.getOwnPropertyNames(source)[Symbol.iterator](),
        _step;
      !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
      _iteratorNormalCompletion = true
    ) {
...
//# sourceMappingURL=temportal.js.map
