    ...
    async connect(): Promise<void> {
        ...
        return new Promise<void>((resolve, reject) => {
            ...
            let continuationToken:
                ...
                | undefined;
            this.wallService.queryEntities<Wall>('walls', new storage.TableQuery(),
                continuationToken as unknown as storage.services.table.TableService.TableContinuationToken,
                (error, result) => {
